import type { Renderer } from '$lib/ogl/core/Renderer';
import { Program } from '$lib/ogl/core/Program';
...
export function makeLandscape(renderer: Renderer, uniforms) {
    ...
    const fragmentPrefix = renderer.isWebgl2
        ...
        : /* glsl */ `#extension GL_OES_standard_derivatives : enable
                        precision highp float;
                    `;
    const vertex = vertexPrefix + shader.vertex;
    const fragment = fragmentPrefix + shader.fragment;
